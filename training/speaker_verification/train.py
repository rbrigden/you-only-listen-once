...
class VerificationTrainer:
    ...
    def __init__(self,
        ...
        self.verification_criterion = ContrastiveLoss(num_search_steps=5)
    ...
    def train_epoch(self, data_loader, alpha=1.0):
        for idx, (data_batch1, data_batch2, label_batch1, label_batch2) in enumerate(data_loader):
            ...
            classification_loss = F.nll_loss(preds1, label_batch1) + F.nll_loss(preds2, label_batch2)
            ...
            yield verification_loss, classification_loss, best_margin

        # Reset the search at each epoch
        self.verification_criterion.margin_searcher.reset()
